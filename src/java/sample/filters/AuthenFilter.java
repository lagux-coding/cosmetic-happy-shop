...
public class AuthenFilter implements Filter {
    ...
    public AuthenFilter() {
        ...
        USER_RESOURCE.add("ShoppingController");
        USER_RESOURCE.add("AddToCartController");
        USER_RESOURCE.add("viewCart.jsp");
        USER_RESOURCE.add("SearchProductController");
        USER_RESOURCE.add("RemoveItemController");
        USER_RESOURCE.add("UpdateItemController");
        USER_RESOURCE.add("CheckoutController");
        USER_RESOURCE.add("ViewOrderController");
        USER_RESOURCE.add("ViewOrderDetailController");
        USER_RESOURCE.add("SendMailController");

        ADMIN_RESOURCE = new ArrayList<>();
        ADMIN_RESOURCE.add("admin.jsp");
        ADMIN_RESOURCE.add("LogoutController");
        ADMIN_RESOURCE.add("SearchUserController");
        ADMIN_RESOURCE.add("UpdateUserController");
        ADMIN_RESOURCE.add("DeleteUserController");
        ADMIN_RESOURCE.add("SearchProductController");
        ADMIN_RESOURCE.add("productManagement.jsp");
        ADMIN_RESOURCE.add("UpdateProductController");
        ADMIN_RESOURCE.add("RemoveProductController");
        ADMIN_RESOURCE.add("AddProductController");
        ADMIN_RESOURCE.add("addProduct.jsp");
        ADMIN_RESOURCE.add("ViewOrderController");
        ADMIN_RESOURCE.add("ViewOrderDetailController");
        ...
        NON_AUTHEN_RESOURCE.add("CreateUserController");
