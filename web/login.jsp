<%-- 
    Document   : login.jsp
    Created on : Jul 3, 2024, 6:47:49 PM
    Author     : Admin
--%>
                                    ...
                                    <div class="row gy-3 overflow-hidden">
                                        <div class="col-12">
                                            <div class="form-floating mb-3">
                                                <input type="text" class="form-control" name="userID" id="email" placeholder="User ID">
                                        ...
                                        <div class="col-12">
                                            <div class="g-recaptcha" data-sitekey="6LcprwUqAAAAAOcO28LsRvOxjcQ5gdUA3GhDLql_"></div>
                                            <div id="error"></div>
                                        </div>
                                        <div class="col-12">
                                            <div class="d-grid">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="d-flex gap-2 gap-md-4 flex-column flex-md-row justify-content-md-end">
                                            <a href="MainController?action=Create_Page" class="link-secondary text-decoration-none">Create new account</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="d-flex gap-2 gap-sm-3 justify-content-center">
                                            <a href="https://accounts.google.com/o/oauth2/auth?scope=email profile openid&redirect_uri=http://localhost:8080/Cosmetic_Happy_Shop/LoginGoogleController&response_type=code&client_id=244184705543-74146e067scuc9uoqtgdfhcdhkriq32r.apps.googleusercontent.com&approval_prompt=force" class="btn btn-lg btn-outline-danger p-3 lh-1">
            ...
            window.onload = function () {
                ...
                form.addEventListener("submit", function(event){
                    ...
                    if(response){
                        ...
                        error.innerHTML = "Please check reCaptcha again";
                    }
                });
            }
        </script>
